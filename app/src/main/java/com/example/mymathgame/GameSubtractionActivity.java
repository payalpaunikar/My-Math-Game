    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(GameSubtractionActivity.this, "Please enter your answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (life<=0)
                {
                    Toast.makeText(GameSubtractionActivity.this, "Game is over", Toast.LENGTH_SHORT).show();
                    Intent i= new Intent(GameSubtractionActivity.this,ResultActivity.class);
